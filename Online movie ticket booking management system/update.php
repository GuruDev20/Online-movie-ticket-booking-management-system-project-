<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        $sql="UPDATE booking SET total_tickets='$tickets' WHERE movie_name='$movie'";
        if($conn->query($sql)===TRUE){
            echo "<div id='ticket-booked-message-container'>";
            echo "<div id='ticket-booked-message'>Your Ticket has been Updated Successfully!<br></div>";
            echo "</div>";
            echo "<style>
    ...
    <section class="login">
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form">
            ...
            <div class="form-group">         
                ...
                <input type="text" id="tickets" name="tickets" class="form-control"><br>
            </div>
            <div class="form-group">
